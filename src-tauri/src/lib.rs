    ...
    let ports = serialport::available_ports()
        ...
        match matched {
            Some(info) => match &info.port_type {
                ...
                serialport::SerialPortType::UsbPort(usb) if usb.vid == RPI_VENDOR_ID => Ok(()),
...
#[tauri::command]
fn save_skin_media(app: tauri::AppHandle, filename: String, data: String) -> Result<String, String> {
...
//handshake verification here, when detect that it is 
